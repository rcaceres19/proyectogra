...
const SearchBar = () => {
  ...
  return (
    <section className="section hero is-small is-info is-bold" style={ {paddingTop: '2rem', paddingBottom: '1.5rem'}}>
            ...
            <div className="column is-two-thirds has-text-centered">
              ...
              <div className="field has-addons">
                ...
                <div className="control">
                  <button className="button is-link is-rounded " onClick={ e => {}}>
                    <span className="icon">
                      <i className="fa fa-search" />
                    </span>
                  </button>
